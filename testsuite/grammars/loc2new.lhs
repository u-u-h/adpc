...
>     motif4 = iloop4	... h
>     iloop4 = ( (il <<< lbase -~~ (region `with` size (1,10)) ~~~ motif_il5 ~~~ (region `with` size (1,1)) ~~- lbase) `with` basepairing	... h)
>     motif_il5 = (sr <<< lbase -~~ motif5 ~~- lbase) `with` basepairing	... h

>     motif5 = hairpin5	... h
>     hairpin5 = (hl <<< lbase -~~ ((region `with` size (3,11)) `with` contains_region "AACCCUU") ~~- lbase) `with` basepairing	... h

>     tail0 = listed ( cadd <<< motif6 ~~~ tail1	... h )
>     motif6 = ss <<< (region `with` (size (20,50)))	... h
...
>     motif11 = hairpin11	... h
>     hairpin11 = (hl <<< lbase -~~ ((region `with` size (3,15)) `with` contains_region "UCCAG") ~~- lbase) `with` basepairing	... h
