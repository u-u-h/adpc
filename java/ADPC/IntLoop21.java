...
public class IntLoop21 {
  ...
  static int intloop21[][][][][][][] = 
    new int[ASIZE+1][ASIZE+1][ASIZE+1][ASIZE+1][ASIZE+1][ASIZE+1][ASIZE+1];
...
*/
  ...
  public static int il12_energy(int lb, int rb)
  {
    return intloop21[s[lb]][s[lb+1]][s[lb+2]][s[rb-3]][s[rb-2]][s[rb-1]][s[rb]];
  }

  public static int il21_energy(int lb, int rb)
  {
    return intloop21[s[rb-2]][s[rb-1]][s[rb]][s[lb]][s[lb+1]][s[lb+2]][s[lb+3]];
  }

public static void init_intloop21(byte[] z)
{
  s = z;
        ...
        for (k4=0;k4<ASIZE+1;k4++)
          for (k5=0;k5<ASIZE+1;k5++)
            for (k6=0;k6<ASIZE+1;k6++)
              for (k7=0;k7<ASIZE+1;k7++)
                intloop21[k1][k2][k3][k4][k5][k6][k7]=550;
