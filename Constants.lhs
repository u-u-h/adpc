...
> ppOutputOption C = "c"
> ppOutputOption Java = "j"

> data Output = Normal | C | F | Pascal | Latex | Java
>                                                   deriving (Eq, Show)
...
> data Prefixes = Prefixes { ptbl, parr, pdifftbl, pdiffarr, poffset, pfct, 
>                            palg, pstr, ptstr, pnew, psigid, ppp, pbuild, pfree, pback, pNTID, pcopy, pupdate :: String} 
>                  deriving Show
